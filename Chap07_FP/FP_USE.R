...
CREATE_FP_USE <- function(IRdata){
  ...
  if (!is.null(IRdata)) {  
    ...
    IRdata <- IRdata %>%
      mutate(fp_evuse_any = 
              as.numeric(ifelse(v302 > 0  & v302 < 8, 1, 0))) %>%  
    ...
    IRdata <- IRdata %>%
      mutate(fp_evuse_fster = 
              as.numeric(ifelse(v305_06 > 0 & v305_06 < 8, 1, 0))) %>%
    ...
    IRdata <- IRdata %>%
      mutate(fp_evuse_mster = 
              as.numeric(ifelse(v305_07 > 0 & v305_07 < 8, 1, 0))) %>%  
    ...
    IRdata <- IRdata %>%
      mutate(fp_evuse_pill = 
              as.numeric(ifelse(v305_01 > 0 & v305_01 < 8, 1, 0))) %>%   
    ...
    IRdata <- IRdata %>%
      mutate(fp_evuse_iud = 
              as.numeric(ifelse(v305_02 > 0 & v305_02 < 8, 1, 0))) %>%   
    ...
    IRdata <- IRdata %>%
      mutate(fp_evuse_inj = 
              as.numeric(ifelse(v305_03 > 0 & v305_03 < 8, 1, 0))) %>%   
    ...
    IRdata <- IRdata %>%
      mutate(fp_evuse_imp = 
              as.numeric(ifelse(v305_11 > 0 & v305_11 < 8, 1, 0))) %>%  
    ...
    IRdata <- IRdata %>%
      mutate(fp_evuse_mcond = 
              as.numeric(ifelse(v305_05 > 0 & v305_05 < 8, 1, 0))) %>%   
    ...
    IRdata <- IRdata %>%
      mutate(fp_evuse_fcond = 
              as.numeric(ifelse(v305_14 > 0 & v305_14 < 8, 1, 0))) %>%   
    ...
    IRdata <- IRdata %>%
      mutate(fp_evuse_diaph = 
              as.numeric(ifelse(v305_04 > 0 & v305_04 < 8, 1, 0))) %>%   
    ...
    IRdata <- IRdata %>%
      mutate(fp_evuse_sdm = 
              as.numeric(ifelse(v305_18 > 0 & v305_18 < 8, 1, 0))) %>%   
    ...
    IRdata <- IRdata %>%
      mutate(fp_evuse_lam = 
              as.numeric(ifelse(v305_13 > 0 & v305_13 < 8, 1, 0))) %>%   
    ...
    IRdata <- IRdata %>%
      mutate(fp_evuse_ec = 
              as.numeric(ifelse(v305_16 > 0 & v305_16 < 8, 1, 0))) %>%   
    ...
    IRdata <- IRdata %>%
      mutate(fp_evuse_omod = 
              as.numeric(ifelse(v305_17 > 0 & v305_17 < 8, 1, 0))) %>%   
    ...
    IRdata <- IRdata %>%
      mutate(fp_evuse_rhy = 
              as.numeric(ifelse(v305_08 > 0 & v305_08 < 8, 1, 0))) %>%   
      set_value_labels(fp_evuse_any = c(yes = 1, no = 0)) %>%
    ...
    IRdata <- IRdata %>%
      mutate(fp_evuse_wthd = 
              as.numeric(ifelse(v305_09 > 0 & v305_09 < 8, 1, 0))) %>%   
    ...
    IRdata <- IRdata %>%
      mutate(fp_evuse_other = 
              as.numeric(ifelse(v305_10 > 0 & v305_10 < 8, 1, 0))) %>%   
    ...
    IRdata <- IRdata %>%
      mutate(fp_evuse_trad = 
              as.numeric(ifelse(fp_evuse_rhy==1 | fp_evuse_wthd==1 | fp_evuse_other==1, 1, 0))) %>%
    ...
    IRdata <- IRdata %>%
      mutate(fp_cruse_any = 
              as.numeric(ifelse(v313 > 0 & v313 < 8, 1, 0))) %>%   
    ...
    IRdata <- IRdata %>%
      mutate(fp_cruse_other = 
            as.numeric(ifelse(v312==10 | v312==35, 1, 0))) %>%   
    ...
    IRdata <- IRdata %>%
      mutate(fp_cruse_trad = 
            as.numeric(ifelse(v313 > 0 & v313 < 3, 1, 0))) %>%   
