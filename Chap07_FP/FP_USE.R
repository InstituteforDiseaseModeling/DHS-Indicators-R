...
# Source for all 
IRdata <- IRdata %>%
  mutate(fp_source_tot = ifelse(!"v326" %in% colnames(IRdata), NA, v326)) %>%
...
IRdata <- IRdata %>%
  mutate(fp_source_fster = 
           ifelse(!all(c("v312", "v326") %in% colnames(IRdata)), NA, ifelse(v312==6, v326, NA))) %>%
...
IRdata <- IRdata %>%
  mutate(fp_source_pill = 
           ifelse(!all(c("v312", "v326") %in% colnames(IRdata)), NA, ifelse(v312==1, v326, NA))) %>%
...
IRdata <- IRdata %>%
  mutate(fp_source_iud = 
           ifelse(!all(c("v312", "v326") %in% colnames(IRdata)), NA, ifelse(v312==2, v326, NA))) %>%
...
IRdata <- IRdata %>%
  mutate(fp_source_inj = 
           ifelse(!all(c("v312", "v326") %in% colnames(IRdata)), NA, ifelse(v312==3, v326, NA))) %>%
...
IRdata <- IRdata %>%
  mutate(fp_source_imp = 
           ifelse(!all(c("v312", "v326") %in% colnames(IRdata)), NA, ifelse(v312==11, v326, NA))) %>%
...
IRdata <- IRdata %>%
  mutate(fp_source_mcond = 
           ifelse(!all(c("v312", "v326") %in% colnames(IRdata)), NA, ifelse(v312==5, v326, NA))) %>%
