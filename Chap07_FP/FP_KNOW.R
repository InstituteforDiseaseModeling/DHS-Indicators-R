...
CREATE_FP_KNOW <- function(IRdata, MRdata) {
    ...
    if (!is.null(IRdata)) {
        ...
        IRdata <- IRdata %>%
            mutate(fp_know_omod = as.numeric(ifelse(v304_17 > 0 & v304_17 < 8, 1, 0))) %>%
        ...
        IRdata <- IRdata %>%
            mutate(fp_know_rhy = as.numeric(ifelse(v304_08 > 0 & v304_08 < 8, 1, 0))) %>%
            set_value_labels(fp_know_rhy = c(yes = 1, no = 0)) %>%
            set_variable_labels(fp_know_rhy = "Know rhythm method")

        # Withdrawal (coitus interruptus)
        IRdata <- IRdata %>%
            mutate(fp_know_wthd = as.numeric(ifelse(v304_09 > 0 & v304_09 < 8, 1, 0))) %>%
        ...
        IRdata <- IRdata %>%
            mutate(fp_know_other = as.numeric(ifelse(v304_10 > 0 & v304_10 < 8, 1, 0))) %>%
            set_value_labels(fp_know_other = c(yes = 1, no = 0)) %>%
            set_variable_labels(fp_know_other = "Know other method")

        # Any traditional
        IRdata <- IRdata %>%
            mutate(fp_know_trad = as.numeric(ifelse(fp_know_rhy == 1 | fp_know_wthd == 1 | fp_know_other == 1, 1, 0))) %>%
        ...
        IRdata <- IRdata %>%
            mutate(fp_know_sum = rowSums(IRdata[, c("fp_know_fster", "fp_know_mster", "fp_know_pill", "fp_know_iud", "fp_know_inj", "fp_know_imp", "fp_know_mcond", "fp_know_fcond", "fp_know_ec", "fp_know_sdm", "fp_know_lam", "fp_know_rhy", "fp_know_wthd", "fp_know_omod", "fp_know_other")])) %>%
        ...
        IRdata <- IRdata %>%
            mutate(fp_know_fert_cor = as.numeric(ifelse(v217 == 3, 1, 0))) %>%
  ...
  if(!is.null(MRdata)){
    ...
    MRdata <- MRdata %>%
      mutate(fp_know_fster = 
              as.numeric(ifelse(mv304_6>0 & mv304_6<8, 1, 0))) %>%
      set_value_labels(fp_know_fster = c(yes = 1, no = 0)) %>%
      set_variable_labels(fp_know_fster = "Know female sterilization")
    ...
    MRdata <- MRdata %>%
      mutate(fp_know_mster = 
              as.numeric(ifelse(mv304_7>0 & mv304_7<8, 1, 0))) %>%
      set_value_labels(fp_know_mster = c(yes = 1, no = 0)) %>%
      set_variable_labels(fp_know_mster = "Know male sterilization")
    ...
    MRdata <- MRdata %>%
      mutate(fp_know_pill = 
              as.numeric(ifelse(mv304_1>0 & mv304_1<8, 1, 0))) %>%
      set_value_labels(fp_know_pill = c(yes = 1, no = 0)) %>%
      set_variable_labels(fp_know_pill = "Know pill")
    ...
    MRdata <- MRdata %>%
      mutate(fp_know_iud = 
              as.numeric(ifelse(mv304_2>0 & mv304_2<8, 1, 0))) %>%
      set_value_labels(fp_know_iud = c(yes = 1, no = 0)) %>%
      set_variable_labels(fp_know_iud = "Know IUD")
    ...
    MRdata <- MRdata %>%
      mutate(fp_know_inj = 
              as.numeric(ifelse(mv304_3>0 & mv304_3<8, 1, 0))) %>%
      set_value_labels(fp_know_inj = c(yes = 1, no = 0)) %>%
      set_variable_labels(fp_know_inj = "Know injectables")
    ...
    MRdata <- MRdata %>%
      mutate(fp_know_imp = 
              as.numeric(ifelse(mv304_11>0 & mv304_11<8, 1, 0))) %>%
      set_value_labels(fp_know_imp = c(yes = 1, no = 0)) %>%
      set_variable_labels(fp_know_imp = "Know implants")
    ...
    MRdata <- MRdata %>%
      mutate(fp_know_mcond = 
              as.numeric(ifelse(mv304_5>0 & mv304_5<8, 1, 0))) %>%
      set_value_labels(fp_know_mcond = c(yes = 1, no = 0)) %>%
      set_variable_labels(fp_know_mcond = "Know male condoms")
    ...
    MRdata <- MRdata %>%
      mutate(fp_know_fcond = 
              as.numeric(ifelse(mv304_14>0 & mv304_14<8, 1, 0))) %>%
      set_value_labels(fp_know_fcond = c(yes = 1, no = 0)) %>%
      set_variable_labels(fp_know_fcond = "Know female condom")
    ...
    MRdata <- MRdata %>%
      mutate(fp_know_ec = 
              as.numeric(ifelse(mv304_16>0 & mv304_16<8, 1, 0))) %>%
      set_value_labels(fp_know_ec = c(yes = 1, no = 0)) %>%
      set_variable_labels(fp_know_ec = "Know emergency contraception")
    ...
    MRdata <- MRdata %>%
      mutate(fp_know_sdm = 
              as.numeric(ifelse(mv304_18>0 & mv304_18<8, 1, 0))) %>%
      set_value_labels(fp_know_sdm = c(yes = 1, no = 0)) %>%
      set_variable_labels(fp_know_sdm = "Know standard days method")
    ...
    MRdata <- MRdata %>%
      mutate(fp_know_lam = 
              as.numeric(ifelse(mv304_13>0 & mv304_13<8, 1, 0))) %>%
      set_value_labels(fp_know_lam = c(yes = 1, no = 0)) %>%
      set_variable_labels(fp_know_lam = "Know LAM")
    ...
    MRdata <- MRdata %>%
      mutate(fp_know_omod = 
              as.numeric(ifelse(mv304_17>0 & mv304_17<8, 1, 0))) %>%
      set_value_labels(fp_know_omod = c(yes = 1, no = 0)) %>%
      set_variable_labels(fp_know_omod = "Know other modern method")
    ...
    MRdata <- MRdata %>%
      mutate(fp_know_rhy = 
              as.numeric(ifelse(mv304_8>0 & mv304_8<8, 1, 0))) %>%
      set_value_labels(fp_know_rhy = c(yes = 1, no = 0)) %>%
      set_variable_labels(fp_know_rhy = "Know rhythm method")
    ...
    MRdata <- MRdata %>%
      mutate(fp_know_wthd = 
              as.numeric(ifelse(mv304_9>0 & mv304_9<8, 1, 0))) %>%
      set_value_labels(fp_know_wthd = c(yes = 1, no = 0)) %>%
      set_variable_labels(fp_know_wthd = "Know withdrawal method")
    ...
    MRdata <- MRdata %>%
      mutate(fp_know_other = 
              as.numeric(ifelse(mv304_10>0 & mv304_10<8, 1, 0))) %>%
      set_value_labels(fp_know_other = c(yes = 1, no = 0)) %>%
    ...
    MRdata <- MRdata %>%
      mutate(fp_know_trad = 
              as.numeric(ifelse(fp_know_rhy==1 | fp_know_wthd==1 | fp_know_other==1, 1, 0))) %>%
      set_value_labels(fp_know_trad = c(yes = 1, no = 0)) %>%
      set_variable_labels(fp_know_trad = "Know any traditional method")
